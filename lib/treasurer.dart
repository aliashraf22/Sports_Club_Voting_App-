...
class treasurer extends StatelessWidget {
            ...
            body: SingleChildScrollView(
                child: Column(
                  ...
                  Container(
                      height: 50,
                      alignment: Alignment.center,
                      child: const Text("1. Khaled Mohamed Latef",
                          style: TextStyle(
                            color: Colors.black,
                            fontSize: 25.0,
                            fontWeight: FontWeight.w800,
                  ...
                  Container(
                      height: 50,
                      alignment: Alignment.center,
                      child: const Text("2. Omar Haredy",
                          style: TextStyle(
                            color: Colors.black,
                            fontSize: 25.0,
                            fontWeight: FontWeight.w800,
